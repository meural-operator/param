...
class CUDAEnumerator(EnumeratorEngine):
    """
    ...
    def batch_evaluate(self, a_bounds: List[List[int]], b_bounds: List[List[int]], target: TargetConstant) -> List[Dict]:
        ...
        # Load arbitrary generalized LHS keys from the TargetConstant implementation
